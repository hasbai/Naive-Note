...
export default {
  ...
  data() {
    return {
      ...
      mql1080: matchMedia('(max-width: 1080px)'),
      mql525: matchMedia('(max-width: 525px)'),
      message: useMessage(),
      dialog: useDialog(),
  ...
  mounted() {
    this.editor = new Vditor(this.path, {
      ...
      toolbar: this.mql525.matches ? this.mobileToolbar : this.desktopToolbar,
      preview: {
        markdown: {
          autoSpace: true,
          fixTermTypo: true,
